...
//  labelled "11" on an Arduino Uno board.
//
...
//
//  The function must turn on a LED connected to the I/O pin labelled "11" 
...
//
//  The function must turn off a LED connected to the I/O pin labelled "11" 
//  on an Arduino Uno board.
//
