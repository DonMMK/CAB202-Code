...
void init_vars () {
    ...
    // INSERT CODE HERE.
    Var_01 = (1 << 0);
    //  Create a bit mask which can be used to access or change bit 3.
    //  Store the bit mask in global variable Var_02.

    // INSERT CODE HERE.
    Var_02 = (1 << 3);
    //  Create a bit mask which can be used to access or change bits 0, 6.
    //  Store the bit mask in global variable Var_03.

    // INSERT CODE HERE.
    Var_03 = (1 << 0) | (1 << 6);
    //  Create a bit mask which can be used to access or change bits 5, 7.
    //  Store the bit mask in global variable Var_04.

    // INSERT CODE HERE.
    Var_04 = (1 << 5) | (1 << 7);
    //  Create a bit mask which can be used to access or change bits 0, 2, 3.
    //  Store the bit mask in global variable Var_05.

    // INSERT CODE HERE.
    Var_05 = (1 << 0) | (1 << 2) | (1 << 3);
    //  Create a bit mask which can be used to access or change bits 3, 4, 6.
    //  Store the bit mask in global variable Var_06.

    // INSERT CODE HERE.
    Var_06 = (1 << 3) | (1 << 4) | (1 << 6);
    //  Create a bit mask which can be used to access or change bits 0, 1, 4, 7.
    //  Store the bit mask in global variable Var_07.

    // INSERT CODE HERE.
    Var_07 = (1 << 0) | (1 << 1) | (1 << 4)| (1<< 7);
    //  Create a bit mask which can be used to access or change bits 1, 2, 4, 7.
    //  Store the bit mask in global variable Var_08.

    // INSERT CODE HERE.
    Var_08 = (1 << 1) | (1 << 2) | (1 << 4)| (1<< 7);
    //  Create a bit mask which can be used to access or change bits 0, 1, 2, 5, 7.
    //  Store the bit mask in global variable Var_09.

    // INSERT CODE HERE.
    Var_09 = (1 << 0) | (1 << 1) | (1<< 2)| (1<< 5) | (1<<7);
