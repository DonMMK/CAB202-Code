...
//Press>> Open >> Closed
//Release>> Closed >> Open
//Click>> Combination of Press + Release
...
//  the I/O pin labelled "2" on an Arduino Uno board. It should also
...
//  a pull-down switch connected to I/O pin labelled "2" on an 
//  Arduino Uno board.
//
...
int is_rising_edge(void){
    unsigned char current_state = PIND & (1<<2); //0, or 0b00000100
