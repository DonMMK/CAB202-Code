...
void setup(void) {
    ...
    //  your student number, "n10454012", followed immediately by a comma,
...
//          6 bits on the right are 1 and the others are 0.
...
ISR(TIMER0_OVF_vect){
  ...
  WRITE_BIT(state_count, 0, BIT_VALUE(PINC, 4));
